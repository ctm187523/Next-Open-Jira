...
function MyApp({ Component, pageProps }: AppProps) {
  return (
      /*colocamos en primer nivel el Provider llamado EntriesProvider creado en context/entries/EntriesProvider
        para que todos los componentes en el metidos(Children) reciban la infomacion compartida */
    <EntriesProvider>
      {/*colocamos en segundo nivel el Provider llamado UIProvider creado en context/ui/UIProvider
        para que todos los componentes en el metidos(Children) reciban la infomacion compartida */}
      <UIProvider>
